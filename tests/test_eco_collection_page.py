...
def test_dropdown_sort_selected(eco_collection_page):
    ...
    eco_collection_page.check_sort_by_value_is_selected('price')
    eco_collection_page.select_sort_by_value('name')
    eco_collection_page.check_sort_by_value_is_selected('name')
    eco_collection_page.select_sort_by_value('position')
    eco_collection_page.check_sort_by_value_is_selected('position')
